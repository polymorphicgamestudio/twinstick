...
public class MoveGroup : MonoBehaviour {
	...
	[SerializeField] protected Vector2 attentionSpanRange = new Vector2(3f, 15f);
	...
	protected virtual void RotateBasedOnMovement(float turnSpeed) {
		Quaternion rotToVel = Quaternion.FromToRotation(Vector3.forward, Vector3.ProjectOnPlane(rb.velocity, Vector3.up));
